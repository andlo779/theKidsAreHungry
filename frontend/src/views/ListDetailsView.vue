  ...
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h2 class="text-2xl font-bold">
        List Details <span v-if="list">({{ list.name }})</span>
      </h2>
      <router-link
        to="/"
    ...
    <div class="space-y-4">
      ...
      >
        <div
          class="bg-gray-100 px-4 py-2 border-b border-gray-200 font-semibold text-gray-700"
        >
          Items
        </div>
        ...
        <ul v-else class="divide-y divide-gray-200">
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <span
                :class="{
                  'line-through text-gray-400': item.is_purchased,
                  'text-gray-900 font-medium': !item.is_purchased,
                }"
              >
                {{ item.name }}
              </span>
