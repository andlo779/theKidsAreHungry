...
<template>
  <div
    class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md border border-gray-200 mt-10"
  >
    <div
      v-if="sessionExpired"
      class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6 rounded shadow-sm"
    >
    ...
    <div class="flex justify-center mb-6">
      <button
        ...
        :class="[
          ...
          isLogin ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700',
        ]"
      >
        Log In
      </button>
